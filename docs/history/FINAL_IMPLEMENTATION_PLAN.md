...
| Surface hierarchy semantics | Complete | Added the five Material surface-container roles, direct Wallpaper mappings, and HCT-derived authored-theme shades; acceptance passed 2026-09-10 |
...
- Surface hierarchy semantics are complete. Wallpaper themes map the
  five Material surface-container roles directly and use `surface_bright` for
  hover; authored themes preserve their surface HCT hue/chroma while applying
  the corresponding standard-contrast Material tone deltas. Contract, HCT,
  dark/light Matugen, hot-reload, restoration, affected QML, lint, and shell
  smoke validation passed. Existing runtime Wallpaper artifacts must be
  regenerated or restored before deployment.
...
### Surface hierarchy semantics milestone

Status: Complete (2026-09-10).

Expand theme schema version 1 from 36 to 41 required roles by adding the five
Material `surface_container*` roles. Wallpaper themes map those roles directly
from Matugen and map `surface_hover` from `surface_bright`. Authored themes use
static colors generated by preserving the existing surface's requested HCT hue
and chroma and applying the Material standard-contrast dark/light tone deltas.

Acceptance requires coordinated schema, validator, theme, fallback, fixture,
and generated-theme updates; exact authored outputs and HCT tone deltas; direct
dark/light Matugen mappings; missing-role rejection; hot reload; default
Wallpaper restoration; QML lint; and persistent-shell smoke validation. Existing
runtime Wallpaper artifacts must be regenerated or restored before deployment;
incomplete schema-v1 themes remain invalid rather than receiving implicit roles.

Acceptance passed on 2026-09-10. Schema/runtime validation, exact authored HCT
outputs and tone deltas, dark/light Matugen fixtures, missing-role rejection,
theme and generated-theme hot reload, Wallpaper restoration and generation,
affected component tests, `qmllint`, and the persistent-shell smoke test passed.
