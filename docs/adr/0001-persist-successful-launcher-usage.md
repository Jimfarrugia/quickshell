...
non-empty queries. Terminal entries are launched through the configured terminal
emulator. Persistence failure does not fail a launch and is reported as a
bounded diagnostic.
